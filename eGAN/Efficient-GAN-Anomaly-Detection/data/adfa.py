...
def _get_dataset():
    ...
    ADFANet_train_X_no_attack=np.load('/home/notebook/attack_generation/saved_attacks_generated/adfa/train_X_no_attack.npy' )
...
def OLD_get_dataset():
    ...
    x_train = x_train[y_train != 1] #select only ANOMALOUS DATA
    y_train = y_train[y_train != 1] #select only ANOMALOUS DATA
