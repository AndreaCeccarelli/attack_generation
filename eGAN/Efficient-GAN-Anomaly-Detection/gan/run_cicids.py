...
#            sess.graph._unsafe_unfinalize() #ADDED
        ...
        attacks=np.zeros((GENERATED_ATTACKS, 121))
        ...
        np.save('/home/notebook/attack_generation/eGAN/Efficient-GAN-Anomaly-Detection/data/cicids_generated_attacks.npy', attacks)
