...
#            sess.graph._unsafe_unfinalize() #ADDED
        ...
        np.save('/home/notebook/attack_generation/eGAN/Efficient-GAN-Anomaly-Detection/data/adfa_generated_attacks.npy', attacks)
        np.save('/home/notebook/attack_generation/saved_attacks_generated/adfa/ALAD-egan.npy', attacks)
